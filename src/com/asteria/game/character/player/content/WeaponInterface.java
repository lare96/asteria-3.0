...
public enum WeaponInterface {
    ...
    SCYTHE(776, 779, 6, new FightType[] { FightType.SCYTHE_REAP, FightType.SCYTHE_CHOP, FightType.SCYTHE_JAB,
    ...
    DAGGER(2276, 2279, 5, new FightType[] { FightType.DAGGER_STAB, FightType.DAGGER_LUNGE, FightType.DAGGER_SLASH,
            FightType.DAGGER_BLOCK }, 7574, 7586),
    SWORD(2276, 2279, 5, new FightType[] { FightType.SWORD_STAB, FightType.SWORD_LUNGE, FightType.SWORD_SLASH,
    ...
    SPEAR(4679, 4682, 6, new FightType[] { FightType.SPEAR_LUNGE, FightType.SPEAR_SWIPE, FightType.SPEAR_POUND,
    ...
    CLAWS(7762, 7765, 4, new FightType[] { FightType.CLAWS_CHOP, FightType.CLAWS_SLASH, FightType.CLAWS_LUNGE,
    ...
    THROWNAXE(4446, 4449, 6, new FightType[] { FightType.THROWNAXE_ACCURATE, FightType.THROWNAXE_RAPID,
