...
public abstract class Location {
     ...
     */
    public static final Location[] WILDERNESS = {
            new SquareLocation(2941, 3518, 3392, 3966, 0)};
    ...
    public Position random() {
        throw new UnsupportedOperationException("No algorithm to generate a " +
                "pseudo-random position from this location!");
    }
     ...
     */
    public static boolean inAllLocation(Position position, Location...
            location) {
     ...
     * {@code false} otherwise.
     */
    public static boolean inAnyLocation(Position position, Location...
            location) {
    ...
    public static boolean inMultiCombat(Node node) {
        return Location.inAnyLocation(node.getPosition(), Location
                .MULTIPLE_COMBAT);
    }
