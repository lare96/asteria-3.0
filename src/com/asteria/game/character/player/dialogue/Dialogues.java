    ...
    public static void npcDialogue(Player player, Expression expression, int
        ...
        switch (text.length) {
            ...
            case 4:
                ...
                break;
            default:
                throw new IllegalArgumentException("Illegal npc dialogue " +
                        "length: " + text.length);
        }
    }
    ...
    public static void playerDialogue(Player player, Expression expression,
        ...
        switch (text.length) {
            ...
            case 4:
                ...
                break;
            default:
                throw new IllegalArgumentException("Illegal player dialogue " +
                        "length: " + text.length);
        }
    }
    ...
    public static void optionDialogue(Player player, String... text) {
        ...
        switch (text.length) {
            ...
            case 5:
                ...
                break;
            default:
                throw new IllegalArgumentException("Illegal dialogue option " +
                        "length: " + text.length);
        }
    }
