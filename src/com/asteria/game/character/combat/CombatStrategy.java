...
/**
 * The blueprint of a combat session that determines how a character will act
 * in
 * combat.
 *
...
public interface CombatStrategy extends PluginContext {
     ...
     * {@link CombatStrategy#canAttack(CharacterNode, CharacterNode)} has and
     * is about to attack {@code victim}.
     *
     * @param character
