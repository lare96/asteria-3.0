...
public final class Settings {
    ...
    /**
     * Players that don't have a username equal to {@code
     * SOCKET_FLOOD_USERNAME}
     * are moved within 200 squares of the home area on login.
     */
    public static final boolean SOCKET_FLOOD = false;

    /**
     * Players that don't have this username are moved within 200 squares of
     * the
    ...
    public static final String[] DEATH_MESSAGES = {
            ...
            "Your killing style is impeccable, -victim- didn't stand a " +
                    "chance!"};

    /**
     * The items that will be kept on death regardless of if a player is
     * skulled
     * or not.
     */
